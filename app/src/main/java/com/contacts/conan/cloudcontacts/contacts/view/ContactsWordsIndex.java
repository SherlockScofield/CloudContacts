package com.contacts.conan.cloudcontacts.contacts.view;
...
/**
 * Created by Conan on 2016/12/2.
 */

public class ContactsWordsIndex extends View {
    ...
    public ContactsWordsIndex(Context context) {
        super(context);
        init();
    }

    public ContactsWordsIndex(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
